FOCA.Model.Login = {
    ...
    esqueci: function (n, user) { 

        $('#btn-esquecisenha-sms').attr('disabled', 'disabled');
        $('#btn-esquecisenha-sms').val('Enviando...');
        ...
        $.ajax({
            ...
            timeout: 120000,
            async: true,
            url: FOCA.Structure.url + "/SetEsqueciSenha",
            contentType: "application/json; charset=utf-8",
            data: JSON.stringify({
                usuario: user
            }),
            success: function (result) {
                ...
                if (retorno.Retorno == "0") {
                    ...
                    $('#btn-esquecisenha-sms').removeAttr('disabled');
                    $('#btn-esquecisenha-sms').val('ESQUECI MINHA SENHA');
                    return false;
                }
