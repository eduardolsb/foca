FOCA.Controller.Kifaxina = {
    ...
    load: function (n) {
        ...
        $('#c1-less').off('click').on('click', function () { var c = parseInt($('#c1').val()); c = (c > 1) ? (c - 1) : (c); $('#c1').val(c); FOCA.Controller.Kifaxina.functions.total(); });
        ...
        $('#c2-less').off('click').on('click', function () { var c = parseInt($('#c2').val()); c = (c > 1) ? (c - 1) : (c); $('#c2').val(c); FOCA.Controller.Kifaxina.functions.total(); });
        ...
        $('#c3-less').off('click').on('click', function () { var c = parseInt($('#c3').val()); c = (c > 1) ? (c - 1) : (c); $('#c3').val(c); FOCA.Controller.Kifaxina.functions.total(); });
        ...
        $('#btn-continuar').off('click').on('click', function () {
           ...
           FOCA.Model.Kifaxina.setDemanda(n, data, $('#total-horas').html(),  $('#total-reais').html(), $('#com_materiais').attr('name'), $('#c1').val(), $('#c2').val(), $('#c3').val(),
                ...
                $('#txt-lavar-cozinha').attr('name'), $('#txt-lavar-fogao').attr('name'), $('#txt-passar').attr('name'));
